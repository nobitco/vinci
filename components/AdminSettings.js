...
const AdminSettings = (props) => {
  ...
  const handleInOut = (e) => { isOut = (e.type === 'mouseout') }
    ...
    <div id='black-transparency' className='row' onClick={handleTrigger}>
      <div id='card' className='col s11 m12' onMouseOut={handleInOut} onMouseOver={handleInOut}>
        ...
        <div className='row'>
          ...
          <div className='divider col s12 hide-on-med-and-up' />
          ...
          <div className='col s12' id='options'>
            <a href='' id='changePasswordBtn' onClick={handleChangePassword} className='grey-text text-darken-1'>
              <PasswordIcon color='#8b8787'
                style={{fontSize: 10, marginBottom: -6, marginRight: 5}} />
                  CAMBIAR CONTRASEÑA
             </a>
            <EditInfoBtn primary
              label='Editar Info'
